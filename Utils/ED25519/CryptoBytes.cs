...
namespace Discord.Core.Utils.ED25519
{
    internal class CryptoBytes
    {
        ...
        {
            if(x.Array == null) throw new ArgumentNullException("x");
            if (y.Array == null) throw new ArgumentNullException("y");
        ...
        internal static void Wipe(byte[] data, int offset, int length)
        {
        ...
        /// <returns>Byte array</returns>
        internal static byte[] FromBase64String(string base64String)
        {
        ...
        /// <returns>Byte array</returns>
        internal static byte[] Base58Decode(string input)
        {
