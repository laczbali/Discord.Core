...
namespace Discord.Core.Utils.ED25519
{
    internal class Sha512
    {
        ...
        internal void Update(ArraySegment<byte> data)
        {
        ...
        internal void Update(byte[] data, int index, int length)
        {
        ...
        internal void Finalize(ArraySegment<byte> output)
        {
        ...
        /// <param name="length">Sequence length</param>
        /// <returns>Hash bytes</returns>
        internal static byte[] Hash(byte[] data, int index, int length)
        {
